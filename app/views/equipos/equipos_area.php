...
<div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex-1 flex flex-col">
    ...
    <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
        ...
        <div class="flex items-center gap-3 flex-1 justify-end">
            ...
            <div class="relative w-full max-w-2xl">
                ...
                <input id="searchInputEquipos" name="searchInput" type="text" placeholder="Buscar computadora..."
    ...
    <div class="overflow-x-auto overflow-y-auto max-h-[500px] scroll-elegante">
        <table id="computadorasTable" class="min-w-full divide-y divide-gray-200 align-middle">
            ...
            <?php if (!empty($computadoras)): ?>
                ...
                <?php endforeach; ?>
                <tr id="sinResultadosComputadoras" class="hidden">
                    <td colspan="7" class="px-6 py-6 text-center text-sm text-gray-400">
                        No se encontraron computadoras con esos criterios.
                    </td>
                </tr>
            <?php else: ?>
                <tr>
