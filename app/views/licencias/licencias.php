<?php include __DIR__ . '/../inc/Header.php'; ?>
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Card Vigentes -->
            <div class="bg-white rounded-xl border border-gray-200 py-2.5 px-4 shadow-sm flex flex-col justify-between min-h-[90px]">
                <div class="flex items-center justify-between gap-2">
                    <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider truncate">Licencias Vigentes</span>
                    <span class="text-[10px] px-2 py-0.5 rounded-md bg-green-50 text-green-700 font-bold whitespace-nowrap">Vigente</span>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 py-2.5 px-4 shadow-sm flex flex-col justify-between min-h-[90px]">
                <div class="flex items-center justify-between gap-2">
                    ...
                    <span class="text-[10px] px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 font-bold whitespace-nowrap">En espera</span>
                </div>
                <div class="flex items-baseline gap-2 mt-1">
                    <!-- SE AGREGÓ ID -->
            ...
            <div class="bg-white rounded-xl border border-gray-200 py-2.5 px-4 shadow-sm flex flex-col justify-between min-h-[90px]">
                <div class="flex items-center justify-between gap-2">
                    <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider truncate">Expiradas / Vencidas</span>
                    <span class="text-[10px] px-2 py-0.5 rounded-md bg-red-50 text-red-700 font-bold whitespace-nowrap">Renovar</span>
                </div>
                <div class="flex items-baseline gap-2 mt-1">
                    <!-- SE AGREGÓ ID -->
                ...
                <table class="min-w-full divide-y divide-gray-200 align-middle">
                   ...
                   <?php if (!empty($licencias)): ?>
                        <?php foreach ($licencias as $licencia): ?>
                            <tr data-search="<?php echo htmlspecialchars(strtolower($licencia['nombreTipoLicencia'] . ' ' . $licencia['codigoLicencia'] . ' ' . $licencia['estadoLicencia']), ENT_QUOTES, 'UTF-8'); ?>" data-estado="<?php echo htmlspecialchars(strtolower($licencia['estadoLicencia']), ENT_QUOTES, 'UTF-8'); ?>">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items    -center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800"><?php echo htmlspecialchars($licencia['nombreTipoLicencia']); ?></p>
                                            <p class="text-xs text-gray-400">Categoría de software</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <p class="text-sm font-mono text-gray-700"><?php echo htmlspecialchars($licencia['codigoLicencia']); ?></p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    ?>
                                    <span class="text-[10px] px-2 py-0.5 rounded-md bg-<?php echo $color; ?>-50 text-<?php echo $color; ?>-700 font-bold whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <button type="button"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487a2.75 2.75 0 113.889 3.89L8.25 20.878 3 22l1.122-5.25L16.862 4.487z" />
                                        </svg>
                                    </button>
                                </td>
                            </tr>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-lg overflow-hidden flex flex-col transform transition-all">
            ...
            <form id="formNuevaLicencia" class="p-6 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <div class="relative flex-1">
                            <select id="idTipoLicencia" name="idTipoLicencia" required class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-700 focus:outline-none focus:border-[#2CA1C8] focus:bg-white transition-all appearance-none">
                ...
                <div>
                    ...
                    <input type="text" id="codigoLicencia" name="codigoLicencia" required placeholder="Ej: XXXXX-XXXXX-XXXXX-XXXXX" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-mono focus:outline-none focus:border-[#2CA1C8] focus:bg-white transition-all">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="estadoLicencia" name="estadoLicencia" required class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-700 focus:outline-none focus:border-[#2CA1C8] focus:bg-white transition-all appearance-none">
                ...
                <div class="flex items-center justify-end gap-3 mt-4 pt-4 border-t border-gray-100">
                    <button type="button" onclick="cerrarModal('modalLicencia')" class="px-4 py-2.5 text-sm font-semibold text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-all cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>
                        Cancelar
                    </button>
                    <button type="submit" id="btnSubmitLicencia" class="inline-flex items-center gap-2 bg-[#2CA1C8] hover:bg-[#1E85A8] text-white px-5 py-2.5 rounded-xl font-semibold text-sm shadow-md transition-all cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17 16h2a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v7a2 2 0 002 2h2m3 4h4m-2-4v4m-7-8h10" />
                        </svg>
                        Guardar Licencia
                    </button>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-xl overflow-hidden flex flex-col transform transition-all">
                    ...
                    <input type="hidden" id="idTipoLicenciaTipo" name="idTipoLicencia" value="">
                        ...
                        <div class="flex gap-2 w-full sm:w-auto">
                            ...
                            <button type="submit" id="btnSubmitTipo" class="w-full sm:w-auto bg-[#2CA1C8] hover:bg-[#1E85A8] text-white px-4 py-2 rounded-xl font-semibold text-sm transition-all h-[38px] cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
                                Añadir
                            </button>
                        </div>
                </form>
                                    ...
                                    <?php foreach ($tipodeLicencias as $tipo): ?>
                                        <tr>
                                            ...
                                            <td class="px-4 py-2.5 text-right">
                                                ...
                                                <button type="button" onclick='editarTipo(<?php echo (int)$tipo["idTipoLicencia"]; ?>, <?php echo json_encode($tipo["nombreTipoLicencia"], JSON_HEX_APOS | JSON_HEX_QUOT); ?>)' class="inline-flex items-center justify-center p-2 rounded-lg bg-cyan-50 text-[#2CA1C8] hover:bg-cyan-100 transition-all mr-2" title="Editar tipo de licencia" aria-label="Editar tipo de licencia">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487a2.75 2.75 0 113.889 3.89L8.25 20.878 3 22l1.122-5.25L16.862 4.487z" />
                                                    </svg>
                                                </button>
                                                <button type="button" onclick="confirmEliminar(<?php echo (int)$tipo['idTipoLicencia']; ?>)" class="inline-flex items-center justify-center p-2 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-all" title="Eliminar tipo de licencia" aria-label="Eliminar tipo de licencia">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="px-6 py-3 bg-gray-50 flex justify-end border-t border-gray-100">
                <button type="button" onclick="cerrarSubModal()" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-xl font-semibold text-xs transition-all cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
                    Regresar a Licencia
                </button>
            </div>
        </div>
